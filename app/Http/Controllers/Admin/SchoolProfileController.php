...
class SchoolProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'footer_contact_label_email' => 'nullable|string|max:100',
            ...
            'footer_info_news' => 'nullable|string|max:100',
            'footer_contact_menu_1' => 'nullable|string|max:100',
            ...
            'school_photo' => 'nullable|image|mimes:jpeg,png,jpg|max:5120',
