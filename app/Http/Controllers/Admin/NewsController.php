...
class NewsController extends Controller
{
    ...
    {
        $news = News::with('category', 'createdBy')->latest()->paginate(10);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.berita')->with('success', 'Berita dan foto berhasil diperbarui!');
    }
     ...
     */
    private function validateNews(Request $request, bool $requiredImage): array
    {
    ...
    /**
     * Simpan file foto berita ke public/uploads/news.
     */
    private function storeImage(Request $request): string
    {
        ...
        $filename = 'news_' . time() . '_' . Str::slug(Str::limit($request->title, 20, '')) . '.' . $file->getClientOriginalExtension();
