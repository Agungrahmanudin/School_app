...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h2>{{ $profile->hero_title ?? ($profile->school_name ?? 'SMK Negeri 1 Indonesia Berprestasi') }}
                                        </h2>
                                        <p>{{ $profile->hero_description ?? ($profile->history ?? 'Membentuk generasi unggul, berkarakter, mandiri, dan berdaya saing global melalui pembelajaran terpadu.') }}
                                        </p>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="white-button first-button">
                                            <a href="{{ route('landing.profile') }}">Profil Lengkap <i
                                                    class="fa fa-arrow-right"></i></a>
                                        </div>
                                        <div class="white-button">
                                            <a href="{{ route('landing.news') }}">Berita Kegiatan <i
                        ...
                        <div class="col-lg-6">
                            <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <div class="hero-image-wrap">
                                    <img src="{{ $heroImage }}"
                                        alt="{{ $profile->hero_title ?? ($profile->school_name ?? 'School Banner') }}">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <p>Data terverifikasi jumlah tenaga pendidik guru, siswa aktif, ekstrakurikuler, dan kegiatan
                            sekolah.</p>
                    </div>
                </div>
            </div>
    ...
    <div id="about" class="about-us section"
        style="padding-top: 80px; padding-bottom: 80px; background: #f8f9fa !important;">
        <div class="container">
            <!-- Section Title -->
            <div class="row mb-4">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <div class="section-heading">
                        ...
                        <p>Membentuk generasi unggul berlandaskan nilai religi, kecakapan vokasi, entrepreneurship, dan
                            profesionalisme.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-8 mb-4 mb-lg-0">
                                ...
                                <div class="speech-content">
                                    "Selamat datang di website resmi {{ $profile->school_name ?? '' }}. Lembaga pendidikan
                                    kejuruan kami berkomitmen membekali peserta didik dengan karakter yang kuat, kompetensi
                                    vokasional yang relevan dengan kebutuhan dunia usaha dan dunia industri (DUDI), serta
                                    jiwa kewirausahaan yang tangguh. Melalui sinergi bersama para pendidik, tenaga
                                    kependidikan, orang tua, dan mitra industri, kami optimis mengantarkan siswa-siswi
                                ...
                                <div class="principal-badge">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center bg-primary text-white rounded-circle shadow-sm"
                                        style="width: 55px; height: 55px; min-width: 55px; font-size: 26px;">
                                        <i class="bi bi-mortarboard-fill"></i>
                                    </div>
                                    <div>
                                        <h6 class="mb-1 fw-bold">{{ $principalName }}</h6>
                                        <small class="text-muted">Kepala Sekolah
                                            {{ $profile->school_name ?? 'SMKN 1 Talaga' }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 text-center school-profile-photo-wrap">
                                @php
                                    ...
                                    if (
                                        !empty($profile->school_photo) &&
                                        file_exists(public_path($profile->school_photo))
                                    ) {
                                        $photoSekolah = asset($profile->school_photo);
                                    }
                                @endphp
                                <img src="{{ $photoSekolah }}" alt="Foto Sekolah"
                                    class="img-fluid rounded-4 shadow-sm school-profile-photo">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7 mb-4">
                    <div class="vm-container">
                        ...
                        <div class="vm-body">
                            ...
                            @else
                                <ul class="vm-list">
                                    <li>Menumbuhkan keimanan dan ketakwaan seluruh warga sekolah melalui pembiasaan
                                        beribadah.</li>
                                    <li>Mengoptimalkan proses pendidikan dan pelatihan vokasi sesuai kebutuhan DUDI.</li>
                                    <li>Mengembangkan kompetensi civitas academica berdasarkan potensi, minat, dan bakat.
                                    </li>
            ...
            <div class="row mt-3">
                <div class="col-12 text-center">
                    <div
                        class="d-inline-flex flex-wrap gap-3 align-items-center justify-content-center p-2 px-4 bg-white rounded-pill shadow-sm border">
                        <span class="text-dark fw-bold"><i class="fa fa-id-card text-primary me-1"></i> NPSN:
                            {{ $profile->npsn ?? '20109988' }}</span>
                        <span class="text-muted">|</span>
                        <span class="text-dark fw-bold"><i class="fa fa-certificate text-warning me-1"></i> Akreditasi:
    ...
    <div class="services section section-odd-white" style="padding-top: 80px; padding-bottom: 80px; background: #ffffff;">
        <div class="container">
                ...
                @forelse($majors as $index => $major)
                    @php
                        ...
                        if (!empty($major->image)) {
                            if (
                                str_starts_with($major->image, 'storage/') ||
                                str_starts_with($major->image, 'uploads/')
                            ) {
                            ...
                            <div class="major-card">
                                @if ($majorImage)
                                    <div class="major-icon" style="background: transparent; padding: 0;">
                                        <img src="{{ $majorImage }}" alt="{{ $major->name }}"
                                ...
                                <p class="major-desc">
                                    {{ Str::limit($major->description ?? 'Kelompok Program Keahlian unggulan dengan kompetensi yang dikembangkan terarah.', 100) }}
                                </p>
                                @if (!empty($major->kaprog))
                                    <div class="major-kaprog mb-3 py-1 px-3 rounded-pill text-center d-inline-block"
                                        style="background: rgba(13, 110, 253, 0.08); font-size: 13px; color: #0d6efd; font-weight: 600;">
                                        <i class="fa fa-user-tie me-1"></i> Kaprog: {{ $major->kaprog }}
                                    </div>
                                @endif
                                @if (!empty($major->concentrations))
                                    @php
                                        $concentrations = array_filter(
            ...
            <div class="row mt-4">
                <div class="col-12 text-center">
                    <div class="white-button">
                        <a href="{{ route('landing.majors') }}"
                            style="background: #4b8ef1; color: #fff !important; padding: 12px 35px !important; border-radius: 25px; box-shadow: 0 4px 15px rgba(75,142,241,0.3);">
    ...
    <div class="services section section-even-gray" style="padding-top: 80px; padding-bottom: 80px; background: #f8f9fa;">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading text-center mb-4" style="margin-bottom: 35px !important;">
                        ...
                        <img src="{{ asset('landing-page/assets/images/heading-line-dec.png') }}" alt=""
                            class="d-block mx-auto my-2">
                        <p>Wadah pengembangan minat, bakat, dan soft skills melalui berbagai kegiatan di luar pembelajaran
                            formal.</p>
                    </div>
                </div>
            </div>
                ...
                @forelse($extracurriculars as $index => $extra)
                    @php
                        ...
                        if (!empty($extra->image)) {
                            if (
                                str_starts_with($extra->image, 'storage/') ||
                                str_starts_with($extra->image, 'uploads/')
                            ) {
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="school-news-card h-100">
                            ...
                            <div class="news-body">
                                ...
                                <h4 class="news-title">
                                    <a
                                        href="{{ route('landing.extracurriculars.detail', $extra->id) }}">{{ Str::limit($extra->name, 45) }}</a>
                                </h4>
                                <p class="news-excerpt">
                                    {{ Str::limit($extra->description ?? 'Wadah pengembangan potensi, minat, dan bakat siswa di sekolah.', 90) }}
                                </p>
                                <div
                                    class="news-footer mt-auto pt-3 border-top d-flex justify-content-between align-items-center">
                                    @if (!empty($extra->coach))
                                        <small class="text-muted"><i class="fa fa-user-tie text-primary me-1"></i>
                                            {{ Str::limit($extra->coach, 18) }}</small>
                                    @else
                                        <small class="text-muted"><i class="fa fa-check-circle text-success me-1"></i>
                                            Aktif</small>
                                    @endif
                                    <a href="{{ route('landing.extracurriculars.detail', $extra->id) }}"
                                        class="btn-stat-link">
            ...
            <div class="row mt-4">
                <div class="col-12 text-center">
                    <div class="white-button">
                        <a href="{{ route('landing.extracurriculars') }}"
                            style="background: #4b8ef1; color: #fff !important; padding: 12px 35px !important; border-radius: 25px; box-shadow: 0 4px 15px rgba(75,142,241,0.3);">
    ...
    <div id="pricing" class="pricing-tables section-odd-white"
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading text-center mb-5">
                        ...
                        <img src="{{ asset('landing-page/assets/images/heading-line-dec.png') }}" alt=""
                            class="d-block mx-auto my-2">
                        <p>Ikuti rangkaian kabar terbaru seputar kegiatan, agenda edukasi, dan prestasi peserta didik kami.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="school-news-card">
                            <div class="news-img-box">
                                ...
                                <span class="news-badge"><i class="fa fa-tag me-1"></i>
                                    {{ $item->category->name ?? 'Berita' }}</span>
                            </div>
                            <div class="news-body">
                                <div class="news-date">
                                ...
                                <h4 class="news-title">
                                    <a
                                        href="{{ route('landing.news.detail', $item->slug) }}">{{ Str::limit($item->title, 50) }}</a>
                                </h4>
                                <p class="news-excerpt">
                                    {!! Str::limit(str_replace('&nbsp;', ' ', strip_tags($item->content, '<b><strong><i><em><u>')), 100) !!}
                                </p>
    ...
    <div class="services section section-even-gray" style="padding-top: 80px; padding-bottom: 80px; background: #f8f9fa;">
        <div class="container">
                            ...
                            <div class="news-img-box">
                                @php
                                    ...
                                    if (!empty($gallery->image)) {
                                        if (
                                            str_starts_with($gallery->image, 'storage/') ||
                                            str_starts_with($gallery->image, 'uploads/')
                                        ) {
            ...
            <div class="row mt-4">
                <div class="col-12 text-center">
                    <div class="white-button"><a href="{{ route('landing.gallery') }}"
                            style="background: #4b8ef1; color: #fff !important; padding: 12px 35px !important; border-radius: 25px; box-shadow: 0 4px 15px rgba(75,142,241,0.3);">Lihat
                            Semua Galeri <i class="fa fa-arrow-right ms-2"></i></a></div>
                </div>
            </div>
        </div>
    </div>
