    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route($backRoute) }}">Ekstrakurikuler</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                <dl class="row mb-0">
                    @php
                        $defaultImage = asset('landing-page/assets/images/about-right-dec.png');
                    @endphp
                        ...
                        <dd class="col-sm-9 mb-3">
                            @if ($isImage)
                                ...
                                <div class="d-inline-block">
                                    <a href="{{ $imgSrc }}" target="_blank" title="Klik untuk melihat ukuran penuh">
                                        <img src="{{ $imgSrc }}" 
                                             alt="{{ $label }}" 
